...
</html><%@ taglib prefix="c" uri="jakarta.tags.core" %>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
    ...
    <div class="hero">
        <div class="hero-left">
            ...
            <div class="hero-actions">
                <a class="btn btn-primary" href="/register">Register Student</a>
                <a class="btn btn-secondary" href="/list">View All Students</a>
            </div>
        </div>
    </div>
    ...
    <div class="dashboard-grid">
        ...
        <div class="card">
            <div class="card-header">
                ...
                <a class="view-all-btn" href="/list">View All</a>
            </div>
                    ...
                    <tbody>
                        <c:forEach var="s" items="${students}">
                            <tr>
                                ...
                                <td class="actions">
                                    <a class="view-btn" href="/view?id=${s.id}">View</a>
                                    <a class="edit-btn" href="/edit?id=${s.id}">Edit</a>
                                </td>
                            </tr>
                        </c:forEach>
